<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeBehind="datewisecomparission.aspx.cs" Inherits="ELabs.WebForm2" %>
                    ...
                    <div class="form-grid col_form">
                        <div class="table-responsive">
                          <%--  <asp:GridView ID="GridView2" runat="server"></asp:GridView>--%>
                            ...
                            <asp:Chart ID="Chart1" runat="server" Height="346px" Width="416px">
                                <Series>
