<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeBehind="pendingreports.aspx.cs" Inherits="DOCTORproject.WebForm2" %>
                  ...
                  <div class="pad_form13">
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnok" runat="server" Text="Ok" CssClass="btn btn-primary" 
                                    onclick="btnok_Click" />
                            <asp:Button ID="btnexcel" runat="server" Text="Excel" CssClass="btn btn-primary" 
                    ...
                    <div class="pad_form11">
                      <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <div class="in_pad">
                       <asp:TextBox ID="txtopdno" runat="server" CssClass="form-control" AutoPostBack="true"
                                    ontextchanged="txtopdno_TextChanged" ></asp:TextBox>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group col-sm-3">
                            ...
                            <asp:DropDownList ID="drppatientname" runat="server" AutoPostBack="true"
                                onselectedindexchanged="drppatientname_SelectedIndexChanged"></asp:DropDownList>
                      ...
                      <div class="col-sm-3">
                       ...
                       <asp:TextBox ID="txtrefferdby" runat="server" CssClass="form-control" AutoPostBack="true"
                                    ontextchanged="txtrefferdby_TextChanged" ></asp:TextBox>
                            ...
                            GridLines="None">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="OPD NO">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("lab_no") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("lab_no") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="City">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox8" runat="server" Text='<%# Bind("villagecity") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label8" runat="server" Text='<%# Bind("villagecity") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Contact">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("contact_no") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="Label9" runat="server" Text='<%# Bind("contact_no") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
